...
from .initializer import block_orthogonal
from .token_indexer import ELMoCharacterMapper
from .scalar_mix import ScalarMix
from .seq2seq import sort_batch_by_length


'''Reference url: https://github.com/allenai/allennlp/blob/master/allennlp/nn/util.py
Update date: April-19-2019'''
def _add_sentence_boundary_token_ids(tensor, mask, sentence_begin_token, sentence_end_token):
...
class Elmo(torch.nn.Module):
    ...
    def forward(self, inputs):
        ...
        for i in range(len(self._scalar_mixes)):
            ...
            representation_without_sentence_boudary, mask_without_sentence_boundary = _remove_sentence_boundaries(
